...
function getWeeklyValues(week) {
  ...
  var totalSalesData = mostProfitable.groupedby// var htmlStr = product_stats.getWeeklyStats(1);
  // res.send(htmlStr);ProductTotalSales(products); // get total product sales
...
exports.getWeeklyStats = function (week) {
  ...
  var htmlString = createHtml(statsMap);
  return htmlString;
}
